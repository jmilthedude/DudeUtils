...
public class PluginEvents {
    ...
    public static void register(DudeUtils plugin) {
        ...
        if (PluginConfigs.FEATURES.ENABLED.get("PortalUtility"))
            plugin.getServer().getPluginManager().registerEvents(new PortalEvents(), plugin);
        if (PluginConfigs.FEATURES.ENABLED.get("Blacklist"))
        ...
        if (PluginConfigs.FEATURES.ENABLED.get("InventorySorter"))
            plugin.getServer().getPluginManager().registerEvents(new InventoryEvents(), plugin);
        if (PluginConfigs.FEATURES.ENABLED.get("SinglePlayerSleep"))
        ...
        if (PluginConfigs.FEATURES.ENABLED.get("NetherWater"))
            plugin.getServer().getPluginManager().registerEvents(new NetherWaterEvent(), plugin);
        if (PluginConfigs.FEATURES.ENABLED.get("VillagerUtility"))
        ...
        if (PluginConfigs.FEATURES.ENABLED.get("ShulkerDropsTwo"))
